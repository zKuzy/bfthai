...
OPENCLOSE.Position = UDim2.new(0.85, 0, 0.0552890813, 0)
...
local win = library:Window("YouTube  ",[[zKuzy]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
local General_Tab = win:Tab("ทั่วไป",[[7040391851]])
local Quest_Tab = win:Tab("    เควสต์ & ไอเท็ม",[[9606626859]])
local PvP_Tab = win:Tab("PvP",[[9606626034]])
local Raid_Tab = win:Tab("ลงดัน",[[9606629300]])
local Shop_Tab = win:Tab("ชอป (ซื้อของ)",[[9606625251]])
...
local Esp_Tab = win:Tab("ESP (มอง)",[[9606628205]])
